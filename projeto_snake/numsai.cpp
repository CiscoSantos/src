...
/*	       clrscr();
	       ...
	       gotoxy(31,1);
	       cprintf("Labirinto = %d", opc_lab);
	       gotoxy(31,2);                              //Vai mostrar ao usuário as opções de nível e labirinto escolhidas por ele.
	       cprintf("Nivel = %d", opc_nivel);

	       gotoxy(31,10);
	       cprintf("Iniciar jogo");
	       gotoxy(31,11);
	       cprintf("Labirintos");
	       gotoxy(31,12);               //Vai imprimir o menu principal novamente.
	       cprintf("Nivel");            //Quando este retorna da função.
	       gotoxy(31,13);
	       cprintf("Sair");
	       gotoxy(31,10);
	       denovo--;//Zera a variável denovo para que o menu principla não seja impresso infinitamente.*/
	  }
